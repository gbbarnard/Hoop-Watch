...
# Serve files from database/static at /static so paths like
# /static/Logos/Boston_Celtics.png work out-of-the-box (matches sample_data.sql)
app = Flask(__name__, static_folder='database/static', static_url_path='/static')
CORS(app)
...
db_config = {
    'host': 'localhost',
    'user': 'root',
    'password': 'IzzyPop2025!',  # Change if needed
    'database': 'hoopwatch'
}
...
def team_logos(filename):
    # Backwards-compat route (optional): serve the same logo files from database/static/Logos
